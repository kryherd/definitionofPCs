...
mice <- mice(dat_imp[,-1], m = 5, maxit = 5, predictorMatrix = predictor.matrix, method = "2l.2stage.norm")
# create mice dataset
...
# mice -- 10 imputations, predictive mean matching method, don't print all output, 20 max iterations
mice_imputeTest <- mice(cc_dat[,-c(1)],  m = 20, maxit = 20, predictorMatrix = predictor.matrix, method = "2l.2stage.norm") 
# create mice dataset
