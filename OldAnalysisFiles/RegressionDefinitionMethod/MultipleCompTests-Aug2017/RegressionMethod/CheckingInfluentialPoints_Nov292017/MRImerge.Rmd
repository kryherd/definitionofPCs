...
dfs <- list("WJ3Int-20_70.csv", "WJ3NoInt-20_70.csv", "KTEAInt-20_70.csv", "KTEANoInt-20_70.csv",
            ...
            "CompositeInt-15_60.csv", "CompositeNoInt-15_60.csv", "WJ3NoImputeInt-15_60.csv", "WJ3NoImputeInt-15_65.csv",
...
data.groups <- lapply(data.groups2, function(x) { x["X.1"] <- NULL; x })
