...
names(md.3) <- c("subject", "cohort", "age", "wj3.watt.raw", "wj3.wid.raw", 
                 "wasi.matr.raw", "wasi.vocab.raw", "wj3.rcomp.raw")
...
m1 <- lm(wj3.rcomp.raw~age+wj3.watt.raw+wj3.wid.raw+wasi.matr.raw+wasi.vocab.raw, data=sct_data)
...
write.csv(residuals, "NoWMCresid.csv")
...
write.csv(sct_data, "df.groups.nowmc.KR.csv")