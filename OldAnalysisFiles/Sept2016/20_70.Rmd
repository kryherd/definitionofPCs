...
Run model, get groups.
```{r}
model.data.lmpp <- data[, c(1, 2, 18, 7, 5, 19, 11)]
...
# center age
lmpp.cc$age.c <- lmpp.cc$age - mean(lmpp.cc$age, na.rm = TRUE)
# composite has already been scaled
...
Run model, get groups.
```{r}
model.data.lmvc <- data[, c(1, 2, 18, 7, 20, 19, 11)]
...
# center age
lmvc.cc$age.c <- lmvc.cc$age - mean(lmvc.cc$age, na.rm = TRUE)
...
Run model, get groups.
```{r}
model.data.lmoc <- data[, c(1, 2, 18, 7, 12, 19, 11)]
...
# center age
lmoc.cc$age.c <- lmoc.cc$age - mean(lmoc.cc$age, na.rm = TRUE)
# composite has already been scaled
...
Run model, get groups.
```{r}
model.data.rlmwv <- data[, c(1, 2, 18, 7, 6, 19, 11)]
...
# center age
rlmwv.cc$age.c <- rlmwv.cc$age - mean(rlmwv.cc$age, na.rm = TRUE)
# composite has already been scaled
...
Run model, get groups.
```{r}
model.data.rlmpp <- data[, c(1, 2, 18, 7, 5, 19, 11)]
...
# center age
rlmpp.cc$age.c <- rlmpp.cc$age - mean(rlmpp.cc$age, na.rm = TRUE)
# composite has already been scaled
...
Run model, get groups.
```{r}
model.data.rlmvc <- data[, c(1, 2, 18, 7, 20, 19, 11)]
...
# center age
rlmvc.cc$age.c <- rlmvc.cc$age - mean(rlmvc.cc$age, na.rm = TRUE)
# composites have already been scaled
...
Run model, get groups.
```{r}
model.data.rlmoc <- data[, c(1, 2, 18, 7, 12, 19, 11)]
...
# center age
rlmoc.cc$age.c <- rlmoc.cc$age - mean(rlmoc.cc$age, na.rm = TRUE)
# composites have already been scaled
